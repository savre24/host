            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Row className="mb-3">
                ...
                <Form.Group as={Col} md="4" controlId="renewalPrice">
                  ...
                  <Form.Control type="number" step="0.01" min="0" name="renewalPrice" placeholder="Same as default" />
                </Form.Group>
              ...
              <Row className="mb-4">
                ...
                <Form.Group as={Col} md="4">
                  ...
                  <div className="mt-2">
                    <input type="checkbox" id="applyOnlineCharge" name="applyOnlineCharge" defaultChecked data-switch="success" />

...
const SideBarFile = () => {
  return <div className="offcanvas-xl offcanvas-start file-manager" tabIndex={-1} id="fileManagerSidebar" aria-labelledby="fileManagerSidebarLabel">
          ...
          <div className="d-flex flex-column">
            ...
            <div className="mt-5 pt-5">
              <div className="alert alert-secondary p-3 pt-0 text-center mb-0" role="alert">
                <Image src={coffeeCup} alt='coffeeCup' className="img-fluid mt-n5" style={{
                maxWidth: 135
              }} />
                <div>

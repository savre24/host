...
const Files = async () => {
  ...
  return <div className="w-100 border-start">
        ...
        <table className="table table-centered table-nowrap border-top mb-0">
          <thead className="bg-light bg-opacity-25">
            <tr>
              ...
              <th className="fs-12 text-uppercase text-muted" style={{
              width: 80
            }}>Action</th>
            </tr>
          </thead>
          <tbody>
            {fileData.map((item, idx) => <tr key={idx}>
                  <td className="ps-3">
                    ...
                    <div className="d-flex align-items-center gap-2">
                      <div>
                        <a href="javascript: void(0);">
                          {item.user?.avatar && <Image src={item.user?.avatar} className="rounded-circle avatar-md" alt="friend" />}
                        </a>
                      </div>
                      <div>

        ...
        <Col xs={12}>
          <Card>
              ...
              <Row>
                <Col xs={4}>
                  <div className="mb-4">
                    ...
                    <h6 className="fs-14 text-muted mb-2 lh-base">1055 Station Street Fremont, <br /> CA - 94539</h6>
                ...
                <Col xs={4}>
                  <div className="mb-4">
                    ...
                    <h6 className="fs-14 text-muted mb-2 lh-base">1147 Rohan Drive Suite, <br />Burlington, VT / 82021</h6>
            ...
            <div className="mt-4">
              ...
              <div>
                <table className="table table-nowrap align-middle mb-0 ms-auto" style={{
                width: 335
              }}>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      <td className="fw-medium">Shipping <small className="text-muted">(Free)</small></td>
          ...
          <div className="d-print-none mb-5">
            <div className="d-flex justify-content-center gap-2">
              <PrintButton />
              <Button variant="secondary"><IconifyIcon icon='tabler:send' className="me-1" /> Send</Button>
              <Button variant="info"><IconifyIcon icon='tabler:download' className="me-1" /> Download</Button>
            </div>
          </div>
        </Col>
      </Row>

...
const DefaultAlert = () => {
  return <ComponentContainerCard title='Default Alert' description={<>
...
const DismissingAlert = () => {
  return <ComponentContainerCard title='Dismissing Alert' description={<> Add a dismiss button and the <code>.alert-dismissible</code> class, which adds
...
const LinkColor = () => {
  return <ComponentContainerCard title='Link Color' description={<>   Use the <code>.alert-link</code> utility class to quickly provide matching
...
const CustomAlerts = () => {
  return <ComponentContainerCard title='Custom Alerts' description={<>Display alert with transparent background and with contextual text color. Use
      classes
...
const AdditionalContent = () => {
  return <ComponentContainerCard title='Additional Content' description={<> Alerts can also contain additional HTML elements like headings, paragraphs and
      dividers.</>}>

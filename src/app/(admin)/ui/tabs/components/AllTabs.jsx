...
const DefaultTabs = () => {
  return <ComponentContainerCard title="Default Tabs" description={<>Simple widget of tabbable panes of local content.</>}>
...
const TabsJustified = () => {
  return <ComponentContainerCard title='Tabs Justified' description={<>Using class <code>.nav-justified</code>, you can force your <code>tab menu items</code> to use the full available width.</>}>
      <TabContainer defaultActiveKey="Profile">
...
const TabsVerticalLeft = () => {
  return <ComponentContainerCard title='Tabs Vertical Left' description={<>You can stack your navigation by changing the flex item direction with the <code>.flex-column</code> utility.</>}>
      <Row>
        <TabContainer defaultActiveKey="Profile">
...
const TabsVerticalRight = () => {
  return <ComponentContainerCard title='Tabs Vertical Right' description={<>You can stack your navigation by changing the flex item direction with the <code>.flex-column</code> utility.</>}>
      <Row>
        <TabContainer defaultActiveKey="Profile">
          <Col sm={9}>
            <TabContent>
...
const TabsBordered = () => {
  return <ComponentContainerCard title='Tabs Bordered' description={<>The navigation item can have a simple bottom border as well. Just specify the class <code>.nav-bordered</code>.</>}>
      <TabContainer defaultActiveKey="Profile">
...
const TabsBorderedJustified = () => {
  return <ComponentContainerCard title='Tabs Bordered Justified' description={<>The navigation item with a simple bottom border and justified</>}>
      <TabContainer defaultActiveKey="Profile">
...
const IconsTabs = () => {
  return <ComponentContainerCard title='Icons Tabs' description={<>The navigation item can have a simple bottom border as well. Just specify the class <code>.nav-bordered</code>.</>}>

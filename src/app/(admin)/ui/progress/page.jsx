...
const Example = () => {
  return <ComponentContainerCard title="Examples" description={<>A progress bar can be used to show a user how far along he/she is in a process.</>}>
...
const HeightProgressBar = () => {
  return <ComponentContainerCard title="Height" description={<>
...
const MultipleBars = () => {
  return <ComponentContainerCard title="Multiple bars" description={<>Include multiple progress bars in a progress component if you need.</>}>
...
const AnimatedStripes = () => {
  return <ComponentContainerCard title="Animated stripes" description={<>
...
const StepsProgressBar = () => {
  return <ComponentContainerCard title='Steps' description={<>Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code> to apply a stripe via CSS gradient over the progress bar’s background color.</>}>
...
const LabelsBar = () => {
  return <ComponentContainerCard title="Labels" description={<>
...
const BackgroundBar = () => {
  return <ComponentContainerCard title="Backgrounds" description={<>Use background utility classes to change the appearance of individual progress bars.</>}>
...
const CustomBackgroundBar = () => {
  return <ComponentContainerCard title="Backgrounds (Custom)" description={<>Use background utility classes to change the appearance of individual progress bars.</>}>
...
const StripedBar = () => {
  return <ComponentContainerCard title="Striped" description={<>

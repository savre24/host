...
const Basic = () => {
  ...
  return <Col md={6}>
      ...
      <p className="text-muted">Toasts are as flexible as you need and
...
const Translucent = () => {
  ...
  return <Col md={6}>
      ...
      <p className="text-muted">Toasts are slightly translucent, too,
...
const Placement = () => {
  ...
  return <Col md={6} className="mt-4">
      ...
      <p className="text-muted">Place toasts with custom CSS as you
...
const CustomContent = () => {
  ...
  return <ComponentContainerCard title='Custom content' description={<>Alternatively, you can also add additional controls
        ...
        <div className="toast-body">
          ...
          <div className="mt-2 pt-2 border-top">
            <button type="button" className="btn btn-primary btn-sm">Take
              action</button> &nbsp;
            <button type="button" onClick={hideCustom3} className="btn btn-secondary btn-sm" data-bs-dismiss="toast">Close</button>
          </div>
        </div>
      </Toast>
      <Toast className="bg-primary" show={isOpenCustom4} onClose={hideCustom4} delay={10000} autohide role="alert" aria-live="assertive" aria-atomic="true">
        <div className="toast-body text-white">
          Hello, world! This is a toast message.
          <div className="mt-2 pt-2 border-top">
            <button type="button" className="btn btn-light btn-sm">Take
              action</button>&nbsp;
            <button type="button" onClick={hideCustom4} className="btn btn-secondary btn-sm" data-bs-dismiss="toast">Close</button>
          </div>
        </div>
      </Toast>
      ...
      <Form>
        <div className="mt-3">
          ...
          <select className="form-select mb-2" onChange={e => setPosition(e?.currentTarget.value)} id="selectToastPlacement">
            ...
            <option value="middle-start">Middle left
            </option>
            <option value="middle-center">Middle center
            </option>
            <option value="middle-end">Middle right
            </option>
            <option value="bottom-start">Bottom left</option>
            <option value="bottom-center">Bottom
              center</option>
...
const AllToasts = () => {
  return <>
      <div>
        <Row>
          <Col xs={12}>
            <ComponentContainerCard title="Bootstrap Toasts" description={<>Push notifications to your visitors with a toast, a

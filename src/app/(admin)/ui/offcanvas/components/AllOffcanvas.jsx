...
const DefaultOffcanvas = () => {
  ...
  return <ComponentContainerCard title='Offcanvas' description={<>You can use a link with the <code>href</code> attribute, or a button with the <code>data-bs-target</code> attribute. In both cases, the <code>data-bs-toggle=&quot;offcanvas&quot;</code> is required.</>}>
...
const OffcanvasBackdrop = () => {
  ...
  return <ComponentContainerCard title='Offcanvas Backdrop' description={<>Scrolling the <code>&lt;body&gt;</code> element is disabled when an offcanvas and its backdrop are visible. Use the <code>data-bs-scroll</code> attribute to toggle <code>&lt;body&gt;</code> scrolling and <code>data-bs-backdrop</code> to toggle the backdrop.</>}>
...
const OffcanvasPlacement = () => {
  ...
  return <ComponentContainerCard title='Offcanvas Placement' description={<><p className="text-muted">
...
const DarkOffcanvas = () => {
  ...
  return <ComponentContainerCard title='Dark Offcanvas' description={<>Change the appearance of offcanvases with utilities to better match them to different contexts like dark navbars.

...
const SimplePopover = () => {
  ...
  return <ComponentContainerCard title='Simple Popover' description={<> Popover is a component which displays a box with a content after a click on an
...
const DismissOnPopover = () => {
  ...
  return <ComponentContainerCard title='Dismiss on Next Click' description={<>Use the <code>focus</code> trigger to dismiss popovers
...
const HoverPopovers = () => {
  ...
  return <ComponentContainerCard title='Hover' description={<>Use the attribute <code>data-bs-trigger=&quot;hover&quot;</code>
...
const FourDirections = () => {
  ...
  return <ComponentContainerCard title='Four Directions' description={<>Four options are available: top, right, bottom, and
      left aligned.</>}>
...
const CustomPopovers = () => {
  ...
  return <ComponentContainerCard title="Custom Popovers" description={<>
...
const DisabledPopover = () => {
  ...
  return <ComponentContainerCard title="Disabled Elements" description={<>

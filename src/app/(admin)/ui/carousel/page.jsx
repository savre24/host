...
const SlidesOnly = () => {
  return <ComponentContainerCard title='Slides Only' description={<>Here’s a carousel with slides only.
...
const SlidesWithControls = () => {
  return <ComponentContainerCard title='With Controls' description={<>Adding in the previous and next controls:</>}>
...
const SlidesWithIndicators = () => {
  return <ComponentContainerCard title='With Indicators' description={<>You can also add the indicators to the
...
const SlidesWithCaptions = () => {
  return <ComponentContainerCard title='With Captions' description={<>Add captions to your slides easily with the <code>.carousel-caption</code> element within any <code>.carousel-item</code>.</>}>
...
const CrossFade = () => {
  return <ComponentContainerCard title='Crossfade' description={<>Add <code>.carousel-fade</code> to your carousel to animate slides with a fade transition instead of a slide.</>}>
...
const IndividualInterval = () => {
  return <ComponentContainerCard title='Individual Interval' description={<>Add <code>data-bs-interval=</code> to a <code>.carousel-item</code> to change the amount of time to delay between automatically cycling to the next item.</>}>

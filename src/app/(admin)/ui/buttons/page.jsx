...
const DefaultButtons = () => {
  return <ComponentContainerCard title="Default Buttons" description={<>Use the button classes on an <code>&lt;a&gt;</code>, <code>&lt;button&gt;</code>, or <code>&lt;input&gt;</code> element.</>}>
...
const ButtonOutline = () => {
  return <ComponentContainerCard title="Button Outline" description={<>Use a classes <code>.btn-outline-**</code> to quickly create a bordered buttons.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const ButtonRounded = () => {
  return <ComponentContainerCard title="Button-Rounded" description={<>Add <code>.rounded-pill</code> to default button to get rounded corners.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const ButtonOutlineRounded = () => {
  return <ComponentContainerCard title="Button Outline Rounded" description={<>Use a classes <code>.btn-outline-**</code> to quickly create a bordered buttons.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const SoftButtons = () => {
  return <ComponentContainerCard title="Soft Buttons" description={<>Use a classes <code>.btn-soft-**</code> to quickly create a soft background color buttons.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const SoftRoundedButtons = () => {
  return <ComponentContainerCard title="Soft Rounded Buttons" description={<>Use a classes <code>.btn-soft-**</code> <code>.rounded-pill</code> to quickly create a soft background color buttons with rounded.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const GradientButtons = () => {
  return <ComponentContainerCard title="Gradient Buttons" description={<>Use the button classes on an <code>&lt;a&gt;</code>, <code>&lt;button&gt;</code>, or <code>&lt;input&gt;</code> element.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const GradientRoundedButtons = () => {
  return <ComponentContainerCard title="Gradient Rounded Buttons" description={<>Use a classes <code>.btn-outline-**</code> to quickly create a bordered buttons.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const GhostButtons = () => {
  return <ComponentContainerCard title="Ghost Buttons" description={<>Use a classes <code>.btn-ghost-**</code> to quickly create a ghost background color buttons.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const GhostRoundedButtons = () => {
  return <ComponentContainerCard title="Ghost Rounded Buttons" description={<>Use a classes <code>.btn-ghost-**</code> <code>.rounded-pill</code> to quickly create a ghost background color buttons with rounded.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const ButtonSizes = () => {
  return <ComponentContainerCard title="Button-Sizes" description={<>Add <code>.btn-lg</code>, <code>.btn-sm</code> for additional sizes.</>}>
...
const ButtonDisabled = () => {
  return <ComponentContainerCard title="Button-Disabled" description={<> Add the <code>disabled</code> attribute to <code>&lt;button&gt;</code> buttons.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const IconButtons = () => {
  return <ComponentContainerCard title="Icon Buttons" description={<>Icon only button.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const BlockButton = () => {
  return <ComponentContainerCard title="Block Button" description={<>Create block level buttons by adding class <code>.d-grid</code> to parent div.</>}>
...
const ButtonGroup = () => {
  return <ComponentContainerCard title="Button Group" description={<>Wrap a series of buttons with <code>.btn</code> in <code>.btn-group</code>.</>}>
...
const ButtonTags = () => {
  return <ComponentContainerCard title="Button tags" description={<>The <code>.btn</code> classes are designed to be used with the <code>&lt;button&gt;</code> element. However, you can also use these classes on <code>&lt;a&gt;</code> or <code>&lt;input&gt;</code> elements (though some browsers may apply a slightly different rendering).</>}>
      <div className="d-flex flex-wrap gap-2">

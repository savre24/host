...
const DefaultBadges = () => {
  return <ComponentContainerCard title='Default' description={<>A simple labeling component. Badges scale to match the size of the immediate parent element by using relative font sizing and <code>em</code> units.</>}>
...
const ContextualVariations = () => {
  return <ComponentContainerCard title='Pill Badges' description={<>Use the <code>.rounded-pill</code> modifier class to make badges more rounded.</>}>
...
const PillBadges = () => {
  return <ComponentContainerCard title='Contextual variations' description={<>Add any of the below mentioned modifier classes to change the appearance of a badge.
...
const BadgePositioned = () => {
  return <ComponentContainerCard title='Badge Positioned' description={<> Use utilities to modify a <code>.badge</code> and position it in the corner of a
      link or button.</>}>
      <Row>
        <Col xs={6}>

...
const SizingImages = () => {
  return <ComponentContainerCard title='Sizing - Images' description={<> Create and group avatars of different sizes and shapes with the css classes.
...
const SizingBackgroundColor = () => {
  return <ComponentContainerCard title='Sizing - Background Color' description={<>Using utilities classes of background e.g. <code>bg-*</code> allows you to have any
...
const RoundedCircle = () => {
  return <ComponentContainerCard title='Rounded Circle' description={<> Using an additional class <code>.rounded-circle</code> in <code className='me-1'>&lt;img&gt;</code>
...
const RoundedCircleBackground = () => {
  return <ComponentContainerCard title='Rounded Circle Background' description={<>  Using an additional class <code>.rounded-circle</code> in <code className='me-1'>&lt;img&gt;</code>
      element creates the rounded avatar.</>}>
      <Row>
        <Col md={4}>
          <div className="avatar-md">
...
const AvatarGroup = () => {
  return <ComponentContainerCard title='Avatar Group' description={<>  Create and group avatars of different sizes and shapes with the css classes.
      Using Bootstrap&apos;s naming convention, you can control size of avatar including
      standard avatar, or scale it up to different sizes.</>}>
      <Row>
        <Col xl={3}>
...
const ImagesShapes = () => {
  return <ComponentContainerCard title='Images Shapes' description={<>Avatars with different sizes and shapes.</>}>
      <Row>
        <Col sm={2}>

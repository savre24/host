...
const SingleButtonDropdowns = () => {
  return <ComponentContainerCard title='Single button dropdowns' description={<>  Any single <code>.btn</code> can be turned into a dropdown
...
const CustomDropdownArrow = () => {
  return <ComponentContainerCard title='Custom Dropdown Arrow' description={<>  Any single <code>.btn</code> can be turned into a dropdown
      toggle with some markup changes. Here’s how you can put them to work
      with either <code>&lt;button&gt;</code>
      elements:</>}>
      <Row>
...
const VariantDropdown = () => {
  return <ComponentContainerCard title='Variant' description={<>The best part is you can do this with any button variant, too:</>}>
...
const DropupVariation = () => {
  return <ComponentContainerCard title='Dropup variation' description={<>Trigger dropdown menus above elements
...
const DropendVariation = () => {
  return <ComponentContainerCard title='Dropend variation' description={<>Trigger dropdown menus at the right of the elements by adding
...
const DisabledItem = () => {
  return <ComponentContainerCard title='Disabled Item' description={<>Add <code>.disabled</code> to items in the dropdown to
...
const DarkDropdowns = () => {
  return <ComponentContainerCard title='Dark dropdowns' description={<>Opt into darker dropdowns to match a dark navbar or custom style
...
const Text = () => {
  return <ComponentContainerCard title='Text' description={<>Place any freeform text within a dropdown menu with text and use spacing utilities. Note that you’ll likely need additional sizing styles to constrain the menu width.</>}>
      <Dropdown className="btn-group">
        <DropdownToggle type="button" className="btn btn-primary" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Text Dropdown
        </DropdownToggle>
...
const MenuAlignment = () => {
  return <ComponentContainerCard title='Menu alignment' description={<> Add <code>.dropdown-menu-end</code>
...
const SplitButtonDropdowns = () => {
  return <ComponentContainerCard title='Split button dropdowns' description={<>  Similarly, create split button dropdowns with virtually the same markup as single
...
const Sizing = () => {
  return <ComponentContainerCard title='Sizing' description={<>Button dropdowns work with buttons of all sizes, including default
...
const DropstartVariation = () => {
  return <ComponentContainerCard title='Dropstart variation' description={<>Trigger dropdown menus at the right of the elements by adding
...
const ActiveItem = () => {
  return <ComponentContainerCard title='Active Item' description={<>Add <code>.active</code> to item in the dropdown to <strong>style
...
const Headers = () => {
  return <ComponentContainerCard title='Headers' description={<>Add a header to label sections of actions in any dropdown menu.</>}>
      <Dropdown className="btn-group">
        <DropdownToggle type="button" className="btn btn-secondary" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Header
        </DropdownToggle>
...
const CenteredDropdowns = () => {
  return <ComponentContainerCard title='Centered dropdowns' description={<>Make the dropdown menu centered below the toggle with
...
const AutoCloseBehavior = () => {
  return <ComponentContainerCard title='Auto close behavior' description={<>By default, the dropdown menu is closed when clicking inside or
...
const FormsDropdown = () => {
  return <ComponentContainerCard title='Forms' description={<>Put a form within a dropdown menu, or make it into a dropdown

...
const ExamplesTooltips = () => {
  return <ComponentContainerCard title='Examples' description={<>Hover over the links below to see tooltips.</>}>
...
const DisabledElements = () => {
  return <ComponentContainerCard title='Disabled Elements' description={<>Elements with the <code>disabled</code> attribute
...
const HoverElements = () => {
  return <ComponentContainerCard title='Hover Elements' description={<>Elements with the <code>disabled</code> attribute
      aren’t interactive, meaning users cannot focus, hover, or click them to trigger
      a tooltip (or popover). As a workaround, you’ll want to trigger the tooltip from
      a wrapper <code>&lt;div&gt;</code> or <code>&lt;span&gt;</code>, ideally made
      keyboard-focusable using <code>tabindex=&quot;0&quot;</code>, and override the
...
const FourDirections = () => {
  return <ComponentContainerCard title='Four Directions' description={<>Hover over the buttons below to see the four tooltips
...
const HTMLTags = () => {
  return <ComponentContainerCard title='HTML Tags' description={<>And with custom HTML added:</>}>
...
const ColorTooltips = () => {
  return <ComponentContainerCard title="Color Tooltips" description={<p className="text-muted fs-14 mb-0">
      ...
      <div className="d-flex flex-wrap gap-2">
        ...
        return <OverlayTrigger placement="top" key={idx} overlay={<Tooltip className={`tooltip-${color}`}>This top tooltip is themed via CSS variables.</Tooltip>}>

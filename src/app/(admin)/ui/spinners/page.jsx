...
const BorderedSpinners = () => {
  return <ComponentContainerCard title="Border Spinner" description={<>Use the border spinners for a lightweight loading indicator.</>}>
      <Spinner className="m-2" />
    </ComponentContainerCard>;
};
const ColorsSpinners = () => {
  return <ComponentContainerCard title="Colors" description={<>You can use any of our text color utilities on the standard spinner.</>}>
...
const AlignmentSpinner = () => {
  return <ComponentContainerCard title="Alignment" description={<>
...
const SpinnersSizes = () => {
  ...
  return <ComponentContainerCard title="Size" description={<>
...
const GrowingSpinners = () => {
  return <ComponentContainerCard title="Growing Spinner" description={<>
...
const ColorGrowingSpinners = () => {
  return <ComponentContainerCard title="Color Growing Spinner" description={<>You can use any of our text color utilities on the standard spinner.</>}>
      {colorVariants.slice(0, 10).map((color, idx) => {
...
const ButtonSpinners = () => {
  return <ComponentContainerCard title="Buttons Spinner" description={<>

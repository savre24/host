...
const DefaultAccordions = () => {
  return <ComponentContainerCard title='Default Accordions' description={'Click the accordions below to expand/collapse the accordion content.'}>
...
const FlushAccordions = () => {
  return <ComponentContainerCard title='Flush Accordions' description={<>Add <code>.accordion-flush</code> to remove the default <code>background-color</code>, some borders, and some rounded corners to render accordions edge-to-edge with their parent container.</>}>
...
const BorderedAccordions = () => {
  return <ComponentContainerCard title='Bordered Accordions' description={<>Using the card component, you can
...
const CustomIconAccordion = () => {
  return <ComponentContainerCard title='Custom Icon Accordion' description={<> Using the card component, you can
      extend the default collapse behavior to create an accordion. To properly achieve
      the accordion style, be sure to use <code>.accordion</code> as a wrapper.</>}>
...
const AlwaysOpenAccordions = () => {
  return <ComponentContainerCard title='Always Open Accordions' description={<>Omit the <code>data-bs-parent</code> attribute on each <code>.accordion-collapse</code> to make accordion items stay open when another item is opened.</>}>
...
const AccordionWithoutArrow = () => {
  return <ComponentContainerCard title='Accordion Without Arrow' description={<>  Using the card component, you can
      extend the default collapse behavior to create an accordion. To properly achieve
      the accordion style, be sure to use <code>.accordion</code> as a wrapper.</>}>

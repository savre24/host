...
const DefaultPagination = () => {
  ...
  return <ComponentContainerCard title='Default Pagination' description={<>Simple pagination inspired by Rdio, great for apps and search results.</>}>
      <nav>
...
const DisabledAndActive = () => {
  return <ComponentContainerCard title='Disabled and active states' description={<>Pagination links are customizable for different circumstances. Use <code>.disabled</code> for links that appear un-clickable and <code>.active</code> to indicate the current page.</>}>
      <nav aria-label="...">
        <Pagination className="mb-0">
...
const AlignmentPagination = () => {
  return <ComponentContainerCard title='Alignment' description={<>Change the alignment of pagination components with flexbox utilities.</>}>
...
const CustomIconPagination = () => {
  return <ComponentContainerCard title='Custom Icon Pagination' description={<>Add <code> .pagination-boxed</code> for rounded pagination.</>}>
      <nav>
...
const CustomColorPagination = () => {
  return <ComponentContainerCard title='Custom Color Pagination' description={<>Add <code> .pagination-boxed</code> for rounded pagination.</>}>
      <nav>
...
const SizingPagination = () => {
  ...
  return <ComponentContainerCard title='Sizing' description={<>Add <code> .pagination-lg</code> or <code> .pagination-sm</code> for additional sizes.</>}>
      <nav>
        <Pagination size="lg">
          <Pagination.Prev />
          {items}
...
const BoxedPagination = () => {
  return <ComponentContainerCard title='Boxed Pagination' description={<>Add <code> .pagination-boxed</code> for rounded pagination.</>}>
      <nav>
        <Pagination className="pagination-boxed">
          <Pagination.Prev />
          <Pagination.Item>1</Pagination.Item>
...
const RoundedPagination = () => {
  return <ComponentContainerCard title='Rounded Pagination' description={<>Add <code> .pagination-rounded</code> for rounded pagination.</>}>
      <nav>
...
const SoftPagination = () => {
  return <ComponentContainerCard title='Soft Pagination' description={<>Add <code> .pagination-rounded</code> for rounded pagination.</>}>
      <nav>
...
const GradientColorPagination = () => {
  return <ComponentContainerCard title='Gradient Color Pagination' description={<>Add <code> .pagination-boxed</code> for rounded pagination.</>}>
      <nav>

...
import { CanadaVectorMapOpts, IraqVectorMapOpts, RussiaVectorMapOpts, SpainVectorMapOpts, UsaVectorMapOpts, worldLineMapOpts, worldMapOpts } from "../data";
import dynamic from "next/dynamic";
const WorldVectorMap = dynamic(() => import('@/components/VectorMap/WorldMap'), {
  ssr: false
});
const GlobalWorldVectorMap = () => {
  return <ComponentContainerCard title="World Vector Map">

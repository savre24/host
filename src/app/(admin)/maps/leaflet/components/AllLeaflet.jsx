...
import { Circle, CircleMarker, FeatureGroup, LayerGroup, LayersControl, MapContainer, Marker, Polygon, Polyline, Popup, Rectangle, Tooltip, TileLayer } from "react-leaflet";
const LeafletQuickMap = () => {
  ...
  return <ComponentContainerCard title="Basic Map">
      <div style={{
      height: 400
    }}>

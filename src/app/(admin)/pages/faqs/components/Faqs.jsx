  ...
  return <Card>
      <CardBody>
        ...
        <Accordion id="accordionExample" defaultActiveKey={'0'}>
          {faqData.General.map((item, idx) => <AccordionItem eventKey={`${idx}`} key={idx}>
  ...
  return <Card>
      <CardBody>
        ...
        <Accordion id="accordionExample2" defaultActiveKey={'0'}>
          {faqData.Integration.map((item, idx) => <AccordionItem eventKey={`${idx}`} key={idx}>
                <AccordionHeader as={'h2'}>
                  {item.question}
                </AccordionHeader>
                <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
  ...
  return <Card>
      <CardBody>
        ...
        <Accordion id="accordionExample3" defaultActiveKey={'0'}>
          {faqData.Payments.map((item, idx) => <AccordionItem eventKey={`${idx}`} key={idx}>
                <AccordionHeader as={'h2'}>
                  {item.question}
                </AccordionHeader>
                <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
  ...
  return <Card>
      <CardBody>
        ...
        <Accordion id="accordionExample4" defaultActiveKey={'0'}>
          {faqData.Shipping.map((item, idx) => <AccordionItem eventKey={`${idx}`} key={idx}>
                <AccordionHeader as={'h2'}>
                  {item.question}
                </AccordionHeader>
                <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
  ...
  return <Card>
      <CardBody>
        ...
        <Accordion id="accordionExample5" defaultActiveKey={'0'}>
          {faqData.Return.map((item, idx) => <AccordionItem eventKey={`${idx}`} key={idx}>
                <AccordionHeader as={'h2'}>
                  {item.question}
                </AccordionHeader>
                <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">

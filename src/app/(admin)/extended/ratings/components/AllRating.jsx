...
const BasicRating = () => {
  ...
  return <ComponentContainerCard title='Basic 5 star rater'>
      <div>
        <Rating style={{
        maxWidth: 160
      }} value={rating} onChange={setRating} id="rater" />
      </div>
    </ComponentContainerCard>;
};
const ReadOnlyExamples = () => {
  return <ComponentContainerCard title='Read Only Examples'>
      <div>
...
const DisabledRating = () => {
  return <ComponentContainerCard title="Disabled Rating Example">
...
const HighlightOnlyRating = () => {
  const [rating, setRating] = useState(3);
  return <ComponentContainerCard title="Highlight only selected Example">
...
const ResetButtonRating = () => {
  const [rating, setRating] = useState(3);
  return <ComponentContainerCard title="Rating With Reset Button">
...
const StarStyles = () => {
  ...
  return <ComponentContainerCard title="Clear/Reset Rater Example">

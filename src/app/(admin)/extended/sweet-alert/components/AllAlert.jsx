      ...
      <Row>
        <Col lg={6}>
          <ComponentContainerCard title='A Basic Message' description={<>Here&apos;s a basic example of SweetAlert.</>}>
            <button type="button" className="btn btn-primary" id="sweetalert-basic" onClick={() => swal.fire({
        ...
        <Col lg={6}>
          <ComponentContainerCard title='Title' description={<>A Title with a Text Under.</>}>
            <button type="button" className="btn btn-primary" id="sweetalert-title" onClick={() => swal.fire({
            title: 'The Internet?',
        ...
        <Col lg={6}>
          <ComponentContainerCard title='HTML' description={<>Here&apos;s an example of SweetAlert with HTML content.</>}>
            <button type="button" className="btn btn-primary" onClick={() => swal.fire({

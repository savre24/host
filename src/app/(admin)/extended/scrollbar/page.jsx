...
const DefaultScrollBar = () => {
  return <ComponentContainerCard title='Default Scroll' description={<>Just use data attribute <code>data-simplebar</code>&nbsp;
            and add <code>max-height: **px</code> oh fix height</>}>
            <SimplebarReactClient className="card-body p-0 py-0 mb-3" style={{
      maxHeight: 250
    }}>
...
const PositionScrollBar = () => {
  return <ComponentContainerCard title='RTL Position' description={<>Just use data attribute
            <code>data-simplebar data-simplebar-direction=&apos;rtl&apos;</code>
            and add <code>max-height: **px</code> oh fix height</>}>
            <SimplebarReactClient className="card-body  py-0 mb-3" data-simplebar-direction="rtl" style={{
      maxHeight: 250
    }}>
                SimpleBar does only one thing: replace the browser&apos;s default scrollbar
                with a custom CSS-styled one without losing performances.
...
const SizeScrollBar = () => {
  return <ComponentContainerCard title='Scroll Size' description={<>Just use data attribute <code>data-simplebar</code>
            and add <code>max-height: **px</code> oh fix height</>}>
            <SimplebarReactClient className="card-body p-0 py-0 mb-3" data-simplebar-lg style={{
      maxHeight: 250
    }}>
                SimpleBar does only one thing: replace the browser&apos;s default scrollbar
                with a custom CSS-styled one without losing performances.
...
const ScrollColor = () => {
  return <ComponentContainerCard title='Scroll Color' description={<>Just use data attribute
            <code>data-simplebar data-simplebar-primary</code>
            and add <code>max-height: **px</code> oh fix height</>}>
            <SimplebarReactClient className="card-body p-0 py-0 mb-3" data-simplebar-primary style={{
      maxHeight: 250
    }}>
                SimpleBar does only one thing: replace the browser&apos;s default scrollbar
                with a custom CSS-styled one without losing performances.

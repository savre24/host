...
const QuotationForm = ({ clients, products, defaultQuotationNumber, defaultTaxRate = 18 }) => {
  ...
  const handleSubmit = (e) => {
    ...
    startTransition(async () => {
      setError(null);
      const result = await createQuotation(data, validItems);
    ...
    <Form onSubmit={handleSubmit}>
      ...
      <Row className="mb-4">
        <Col md={6}>
          ...
          <Form.Group className="mb-3" controlId="quoteNumber">
            <Form.Label>Quotation Number</Form.Label>
            <Form.Control required type="text" name="quoteNumber" defaultValue={defaultQuotationNumber} />
          </Form.Group>
        </Col>
        ...
        <Col md={6}>
          <Form.Group className="mb-3" controlId="date">
            ...
            <Form.Control required type="date" name="date" defaultValue={new Date().toISOString().split('T')[0]} />
          </Form.Group>
          <Form.Group className="mb-3" controlId="validUntil">
            <Form.Label>Valid Until</Form.Label>
            <Form.Control required type="date" name="validUntil" defaultValue={new Date(Date.now() + 15 * 24 * 60 * 60 * 1000).toISOString().split('T')[0]} />
          </Form.Group>
        </Col>
      </Row>
      ...
      <Row className="mb-4">
        <Col md={6}>
          <Form.Group className="mb-3" controlId="notes">
            ...
            <Form.Control as="textarea" rows={3} name="notes" placeholder="Thank you for your business!" />
          </Form.Group>
          <Form.Group controlId="terms">
            <Form.Label>Terms and Conditions</Form.Label>
            <Form.Control as="textarea" rows={3} name="terms" placeholder="Terms and conditions..." />
          </Form.Group>
          <Form.Group className="mt-4">
            ...
            <div className="d-flex gap-3">
              ...
              <Form.Check type="radio" id="status-sent" name="status" label="Sent" value="SENT" />
              <Form.Check type="radio" id="status-accepted" name="status" label="Accepted" value="ACCEPTED" />
            </div>
          </Form.Group>
        </Col>
      ...
      <div className="d-grid gap-2 d-md-flex justify-content-md-end">
        <Button variant="outline-secondary" type="button" onClick={() => router.push('/quotations')}>
          Cancel
        </Button>

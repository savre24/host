...
const BasicSlider = () => {
  return <ComponentContainerCard title='Basic Range Slider'>
      <Nouislider range={{
      min: 0,
      max: 255
...
const MultiSlider = () => {
  return <ComponentContainerCard title='Multi Elements Range'>
      <Nouislider range={{
      min: 0,
      max: 100
    }} start={[20, 80]} connect />
...
const ValueRangeSlider = () => {
  ...
  return <ComponentContainerCard title='Value Range Slider'>
      <div>
...
const ColorScheme = () => {
  return <ComponentContainerCard title='Color Scheme'>
      <div>
      ...
      <div className="mt-3">
        ...
        <div id="slider-primary" data-slider-color="secondary">
          ...
          min: 0,
          max: 255
        }} start={127} connect={[true, false]} data-slider-color="primary" />
        </div>
      </div>
      <div className="mt-3">
        ...
        <div id="slider-primary" data-slider-color="success">
          ...
          min: 0,
          max: 255
        }} start={127} connect={[true, false]} data-slider-color="success" />
        </div>
      </div>
      <div className="mt-3">
        ...
        <div id="slider-primary" data-slider-color="info">
          ...
          min: 0,
          max: 255
        }} start={127} connect={[true, false]} data-slider-color="info" />
        </div>
      </div>
      <div className="mt-3">
        ...
        <div id="slider-primary" data-slider-color="warning">
          ...
          min: 0,
          max: 255
        }} start={127} connect={[true, false]} data-slider-color="warning" />
        </div>
      </div>
      <div className="mt-3">
        ...
        <div id="slider-primary" data-slider-color="danger">
          ...
          min: 0,
          max: 255
        }} start={127} connect={[true, false]} data-slider-color="danger" />
        </div>
      </div>
    </ComponentContainerCard>;
};
const TooltipSlider = () => {
  return <ComponentContainerCard title='Tooltip'>
      <Nouislider range={{
      min: 0,
      max: 100
...
const ColorPickerSlider = () => {
  ...
  return <ComponentContainerCard title='Color Picker'>
      <div>
...
const VerticalRangeSlider = () => {
  return <ComponentContainerCard title='Vertical Range Slider'>
      <Nouislider style={{
      height: '198px'
    }} className="mx-auto" range={{
      min: 0,
      max: 200
...
const VerticalRangeSlider2 = () => {
  return <ComponentContainerCard title='Vertical Range Slider'>
      ...
      min: 0,
      max: 255
    }} start={127} connect={[false, true]} orientation="vertical" />
    </ComponentContainerCard>;
};
const VerticalRangeSlider3 = () => {
  return <ComponentContainerCard title='Vertical Range Slider'>
      ...
      min: 0,
      max: 255
    }} start={127} tooltips={true} orientation="vertical" />
    </ComponentContainerCard>;
};
const AllSlider = () => {
  return <>

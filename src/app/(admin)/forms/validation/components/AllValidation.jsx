...
const CustomStylesValidation = () => {
  ...
  return <ComponentContainerCard title="Custom styles" description={<>Custom feedback styles apply custom colors, borders,
...
const TooltipsValidation = () => {
  ...
  return <ComponentContainerCard title="Tooltips" description={<>If your form layout allows it, you can swap the&nbsp;

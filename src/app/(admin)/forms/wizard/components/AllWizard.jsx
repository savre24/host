...
const StepOne = () => <div className="tab-pane" id="basictab1">
    <Row className="">
      <Col xs={12}>
        <Row className=" mb-3">
...
const StepTwo = () => <div className="tab-pane" id="basictab2">
    <Row>
      <Col>
        <Row className=" mb-3">
...
const StepTwoLast = () => {
  return <div className="tab-pane" id="basictab2">
      <Row className="">
        <Col xs={12}>
          <Row className=" mb-3">
            <label className="col-md-3 col-form-label" htmlFor="name"> First name</label>
...
const StepThree = () => <div className="tab-pane" id="basictab3">
    <Row className="">
      <Col xs={12}>
      ...
      <Col lg={6}>
        <ComponentContainerCard title="Wizard With Progress Bar">
          ...
          <div className="tab-content b-0 mb-0">
            <ProgressBar style={{
            height: 7
          }} animated striped variant="success" now={activeStep / steps.length * 100} // Calculate progress

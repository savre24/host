                ...
                <Row>
                  ...
                  <Col lg={4} md={6}>
                    <div className="mb-3">
                      ...
                      <ChoicesFormInput className="form-control" id="choices-single-no-search" options={{
                ...
                <Row>
                  ...
                  <Col lg={4} md={6}>
                    <div className="mb-3">
                      ...
                      <ChoicesFormInput className="form-control" options={{
                      removeItemButton: true
                    }} id="choices-multiple-remove-button" data-choices data-choices-removeitem multiple>
                        <option value="Choice 1" selected>Choice 1</option>
                        <option value="Choice 2">Choice 2</option>
                        <option value="Choice 3">Choice 3</option>

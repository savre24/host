...
export const stackedBarChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    stacked: true,
...
export const fullStackedBarChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    stacked: true,
...
export const negativeBarChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    stacked: true,
...
export const reversedBarChartOpts = {
  series: [{
...
export const imageBarChartOpts = {
  chart: {
    height: 450,
    type: 'bar',
    toolbar: {
...
export const patternBarChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    stacked: true,
...
export const markersBarChartOpts = {
  series: [{
    name: 'Actual',
    data: [{
      x: '2017',

...
const BasicBarChart = () => {
  return <ComponentContainerCard title="Basic Bar Chart">
      <div dir="ltr">
...
const GroupedBarChart = () => {
  return <ComponentContainerCard title="Grouped Bar Chart">
      <div dir="ltr">
...
const StackedBarChart = () => {
  return <ComponentContainerCard title="Stacked Bar Chart">
      <div dir="ltr">
...
const Stacked100BarChart = () => {
  return <ComponentContainerCard title="100% Stacked Bar Chart">
      <div dir="ltr">
...
const NegativeValuesBarChart = () => {
  return <ComponentContainerCard title="Bar with Negative Values">
      <div dir="ltr">
...
const ReversedBarChart = () => {
  return <ComponentContainerCard title="Reversed Bar Chart">
      <div dir="ltr">
...
const ImageBarChart = () => {
  return <ComponentContainerCard title="Bar with Image Fill">
      <div dir="ltr">
...
const DataLabelsBarChart = () => {
  return <ComponentContainerCard title="Custom DataLabels Bar">
      <div dir="ltr">
...
const PatternedBarChart = () => {
  return <ComponentContainerCard title="Patterned Bar Chart">
      <div dir="ltr">
...
const MarkersChart = () => {
  return <ComponentContainerCard title="Bar with Markers">
      <div dir="ltr">

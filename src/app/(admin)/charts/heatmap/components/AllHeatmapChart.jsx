...
const BasicHeatmapChart = () => {
  return <ComponentContainerCard title="Basic Heatmap - Single Series">
      <div dir="ltr">
...
const MultipleHeatmapChart = () => {
  return <ComponentContainerCard title="Heatmap - Multiple Series">
      <div dir="ltr">
...
const HeatmapColorRangeChart = () => {
  return <ComponentContainerCard title="Heatmap - Color Range">
      <div dir="ltr">
...
const HeatmapRangeShadesChart = () => {
  return <ComponentContainerCard title="Heatmap - Range without Shades">
      <div dir="ltr">

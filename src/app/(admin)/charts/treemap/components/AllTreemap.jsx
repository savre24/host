...
const BasicTreemap = () => {
  return <ComponentContainerCard title="Basic Treemap">
      <div dir="ltr">
...
const MultipleTreemap = () => {
  return <ComponentContainerCard title="Treemap Multiple Series">
      <div dir="ltr">
...
const DistributedTreemap = () => {
  return <ComponentContainerCard title="Distributed Treemap">
      <div dir="ltr">
...
const ColorTreemap = () => {
  return <ComponentContainerCard title="Color Range Treemap">
      <div dir="ltr">

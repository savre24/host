...
const ScatterChart = () => {
  return <ComponentContainerCard title='Scatter (XY) Chart'>
      <div dir="ltr">
...
const ScatterDatetimeChart = () => {
  return <ComponentContainerCard title='Scatter Chart - Datetime'>
      <div dir="ltr">
...
const ScatterImagesChart = () => {
  return <ComponentContainerCard title='Scatter - Images'>
      <div dir="ltr">

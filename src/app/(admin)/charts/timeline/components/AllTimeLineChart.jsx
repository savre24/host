...
const BasicTimeline = () => {
  return <ComponentContainerCard title='Basic Timeline'>
      <div dir="ltr">
...
const DistributedTimeline = () => {
  return <ComponentContainerCard title='Distributed Timeline'>
      <div dir="ltr">
...
const MultiSeriesTimeline = () => {
  return <ComponentContainerCard title='Multi Series Timeline'>
      <div dir="ltr">
...
const AdvancedTimeline = () => {
  return <ComponentContainerCard title='Advanced Timeline'>
      <div dir="ltr">
...
const MultipleGroupTimeline = () => {
  return <ComponentContainerCard title='Multiple Series - Group Rows'>
      <div dir="ltr">

...
const BasicRadarChart = () => {
  return <ComponentContainerCard title='Basic Radar Chart'>
      <div dir="ltr">
...
const PolygonRadarChart = () => {
  return <ComponentContainerCard title='Radar with Polygon-fill'>
      <div dir="ltr">
...
const MultipleSeriesChart = () => {
  ...
  return <ComponentContainerCard title="Radar – Multiple Series">

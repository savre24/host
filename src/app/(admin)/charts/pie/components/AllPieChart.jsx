...
const SimplePieChart = () => {
  return <ComponentContainerCard title='Simple Pie Chart'>
      <div dir="ltr">
...
const SimpleDonutChart = () => {
  return <ComponentContainerCard title='Simple Donut Chart'>
      <div dir="ltr">
...
const MonochromePieChart = () => {
  return <ComponentContainerCard title='Monochrome Pie Chart'>
      <div dir="ltr">
...
const GradientDonutChart = () => {
  return <ComponentContainerCard title='Gradient Donut Chart'>
      <div dir="ltr">
...
const PatternedDonutChart = () => {
  return <ComponentContainerCard title='Patterned Donut Chart'>
      <div dir="ltr">
...
const ImagePieChart = () => {
  return <ComponentContainerCard title='Pie Chart with Image fill'>
      <div dir="ltr">
...
const DonutUpdateChart = () => {
  ...
  return <ComponentContainerCard title="Donut Update">

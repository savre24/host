...
const BasicColumnChart = () => {
  return <ComponentContainerCard title="Basic Column Chart">
      <div dir="ltr">
...
const DatalabelsChart = () => {
  return <ComponentContainerCard title="Column Chart with Datalabels">
      <div dir="ltr">
...
const StackedColumnChart = () => {
  return <ComponentContainerCard title="Stacked Column Chart">
      <div dir="ltr">
...
const FullStackedColumnChart = () => {
  return <ComponentContainerCard title="100% Stacked Column Chart">
      <div dir="ltr">
...
const ColumnMarkersChart = () => {
  return <ComponentContainerCard title="Column with Markers">
      <div dir="ltr">
...
const ColumnGroupChart = () => {
  return <ComponentContainerCard title="Column with Group Label">
      <div dir="ltr">
...
const ColumnRotatedChart = () => {
  return <ComponentContainerCard title="Column Chart with rotated labels &amp; Annotations">
      <div dir="ltr">
...
const ColumnNegativeValuesChart = () => {
  return <ComponentContainerCard title="Column Chart with negative values">
      <div dir="ltr">
...
const DistributedColumnChart = () => {
  return <ComponentContainerCard title="Distributed Column Chart">
      <div dir="ltr">
...
const RangeColumnChart = () => {
  return <ComponentContainerCard title="Range Column Chart">
      <div dir="ltr">

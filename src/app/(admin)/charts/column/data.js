export const basicColumnChartOpts = {
  chart: {
    height: 396,
    type: 'bar',
    toolbar: {
...
export const stackedColumnChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    stacked: true,
...
export const datalabelsColumnChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    toolbar: {
...
export const fullStackedColumnChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    stacked: true,
...
export const columnMarkersChartOpts = {
  series: [{
    name: 'Actual',
    data: [{
      x: '2011',
  ...
  legend: {
    ...
    markers: {
      fillColors: ["#6b5eae", "#fbcc5c"]
    }
  }
};
export const columnGroupChartOpts = {
  series: [{
    name: "Sales",
    data: [{
      x: '2020/01/01',
...
export const rotateColumnChartOpts = {
  annotations: {
    points: [{
      x: 'Bananas',
      seriesIndex: 0,
...
export const negativeColumnChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    toolbar: {
...
export const distributedColumnChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    toolbar: {
  ...
  colors: ["#6b5eae", "#35b8e0", "#31ce77", "#fa5c7c", "#fbcc5c", "#39afd1", "#e3eaef", "#313a46"],
  plotOptions: {
    bar: {
      columnWidth: '45%',
      distributed: true
...
export const rangeColumnChartOpts = {
  chart: {
    height: 380,
    type: 'rangeBar'
  },

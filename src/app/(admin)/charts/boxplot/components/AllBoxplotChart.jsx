...
const BasicBoxplot = () => {
  return <ComponentContainerCard title='Basic Boxplot'>
      <div dir="ltr">
...
const ScatterBoxplot = () => {
  return <ComponentContainerCard title='Scatter Boxplot'>
      <div dir="ltr">
...
const HorizontalBoxPlot = () => {
  return <ComponentContainerCard title='Horizontal BoxPlot'>
      <div dir="ltr">

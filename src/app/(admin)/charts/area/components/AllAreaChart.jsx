...
const BasicAreaChart = () => {
  return <ComponentContainerCard title="Basic Area Chart">
      <div dir="ltr">
...
const SplineArea = () => {
  return <ComponentContainerCard title="Spline Area">
      <div dir="ltr">
...
const DatetimeChart = () => {
  return <ComponentContainerCard title="Area Chart - Datetime X-axis">
...
const NegativeValuesChart = () => {
  return <ComponentContainerCard title="Area with Negative Values">
      <div dir="ltr">
...
const StackedArea = () => {
  return <ComponentContainerCard title="Stacked Area">
      <div dir="ltr">
...
const TimeSeriesChart = () => {
  return <ComponentContainerCard title="Irregular TimeSeries">
      <div dir="ltr">
...
const NullValuesChart = () => {
  return <ComponentContainerCard title="Area Chart with Null values">
      <div dir="ltr">

...
export const dateTimeChartChartOpts = {
  annotations: {
    yaxis: [{
      y: 30,
      borderColor: '#999',
...
export const NegativeValuesChartOpts = {
  chart: {
    height: 380,
    type: 'area'
    // zoom: {
...
export const timeSeriesChartOpts = {
  series: [{
    name: 'PRODUCT A',
    data: dataSet[0]
  }, {
...
export const nullValuesChartOpts = {
  colors: ["#39afd1"],
  series: [{
    name: 'Network',
    data: [{

...
const SimpleCandlestickChart = () => {
  return <ComponentContainerCard title='Simple Candlestick Chart'>
      <div dir="ltr">
...
const CategoryChart = () => {
  return <ComponentContainerCard title='Category X-Axis'>
      <div dir="ltr">
...
const CandlestickLineChart = () => {
  return <ComponentContainerCard title='Candlestick with Line'>
      <div dir="ltr">

...
const BasicRadialBarChart = () => {
  return <ComponentContainerCard title="Basic RadialBar Chart">
      {/* <div dir="ltr"> */}
...
const MultipleRadialBars = () => {
  return <ComponentContainerCard title="Multiple RadialBars">
      {/* <div dir="ltr"> */}
...
const CircleChart = () => {
  return <ComponentContainerCard title="Circle Chart - Custom Angle">
...
const CircleImageChart = () => {
  return <ComponentContainerCard title="Circle Chart with Image">
      <div dir="ltr">
...
const StrokedCircularChart = () => {
  return <ComponentContainerCard title="Stroked Circular Guage">
      <div dir="ltr">
...
const GradientCircularChart = () => {
  return <ComponentContainerCard title="Gradient Circular Chart">
      <div dir="ltr">
...
const SemiCircleChart = () => {
  return <ComponentContainerCard title="Semi Circle Gauge">
      <div dir="ltr">

...
const SimpleLineChart = () => {
  return <ComponentContainerCard title="Simple line chart">
      <div dir="ltr">
...
const LineWithData = () => {
  return <ComponentContainerCard title="Line with Data Labels">
      <div dir="ltr">
...
const ZoomableTimeseries = () => {
  return <ComponentContainerCard title="Zoomable Timeseries">
      <div dir="ltr">
...
const AnnotationsChart = () => {
  return <ComponentContainerCard title="Line Chart with Annotations">
      <div dir="ltr">
...
const SyncingCharts = () => {
  return <ComponentContainerCard title="Syncing charts">
...
const GradientLineChart = () => {
  return <ComponentContainerCard title="Gradient Line Chart">
      <div dir="ltr">
...
const MissingNullValuesChart = () => {
  return <ComponentContainerCard title="Missing / Null values">
      <div dir="ltr">
...
const DashedLineChart = () => {
  return <ComponentContainerCard title="Dashed Line Chart">
      <div dir="ltr">
...
const SteplineChart = () => {
  return <ComponentContainerCard title="Stepline Chart">
      <div dir="ltr">
...
const BrushChart = () => {
  return <ComponentContainerCard title="Brush Chart">
      <div dir="ltr">

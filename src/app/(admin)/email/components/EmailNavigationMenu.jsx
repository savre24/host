...
const EmailNavigationMenu = ({
  ...
  return width > 1400 ? <div className="email-sidebar">
      <NavBar showAllEmails={showAllEmails} showStarredEmails={showStarredEmails} isOpenCompose={isOpenCompose} toggleCompose={toggleCompose} />

    </div> : <div className="email-sidebar">

...
const EmailArea = () => {
  ...
  return <>
              ...
              <table className="table table-hover mail-list mb-0">
                <tbody>
                  ...
                  return <tr className="position-relative" key={idx} onClick={toggle}>
                          ...
                          <td>
                            {item.isAttachment && <Link href="" className="link-reset text-truncate text-nowrap"> <IconifyIcon icon="tabler:paperclip" /> {item.isAttachment} </Link>}
                          </td>
                          <td>
      ...
      <Modal show={isTrue} size='lg' onHide={toggle} id="email-details-modal" className="fade" tabIndex={-1} role="dialog" aria-labelledby="email-details-modalLabel" aria-hidden="true">
        ...
        }} data-bs-toggle="modal"><IconifyIcon icon='tabler:arrow-back-up' className="align-text-bottom me-1" /> Reply</button>
          <button className="btn btn-primary" data-bs-target="#email-compose-modal" onClick={() => {
          isToggleCompose(), toggle();
        }} data-bs-toggle="modal"><IconifyIcon icon='tabler:arrow-big-right' className="align-text-bottom me-1" /> Forward</button>
        </ModalFooter>
      </Modal>
    </>;
};

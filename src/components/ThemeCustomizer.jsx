            ...
            <Row>
                {modes.map((item, idx) => <Col xs={4} key={item.mode + idx}>
                            <div className="form-check card-radio">
                                <input className="form-check-input" type="radio" name="data-bs-theme" id={`layout-color-${item.mode}`} onChange={() => changeTheme(item.mode)} checked={theme === item.mode} />
...
const OrientationScheme = () => {
  ...
  return <>
            ...
            <Row>
                {modes.map((item, idx) => <Col xs={4} key={item.mode + idx}>
                            <div className="form-check card-radio">
                                <input className="form-check-input" type="radio" name="data-layout" id={`layout-type-${item.mode}`} onChange={() => changeLayoutOrientation(item.mode)} checked={layoutOrientation === item.mode} />
...
const LayoutMode = () => {
  ...
  return <>
            ...
            <Row>
                <Col xs={4}>
                    <div className="form-check card-radio">
                        <input className="form-check-input" type="radio" name="data-layout-mode" id="layout-mode-fluid" onChange={() => changeLayoutMode('fluid')} checked={layoutMode === 'fluid'} />
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-layout-mode" id="data-layout-detached" onChange={() => changeLayoutMode('detached')} checked={layoutMode === 'detached'} />
...
const MenuTheme = () => {
  ...
  return <>
            ...
            <Row>
                {modes.map((mode, idx) => <Col xs={3} key={idx}>
                            <div className="form-check sidebar-setting card-radio">
                                <input className="form-check-input" type="radio" name="data-menu-color" id={`sidenav-color-${mode}`} onChange={() => changeMenuTheme(mode)} checked={theme === mode} />
...
const SidebarSize = () => {
  ...
  return <>
            ...
            <Row>
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id={`sidenav-size-${'default'}`} onChange={() => changeMenuSize('default')} checked={menuSize === 'default'} />
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-compact" onChange={() => changeMenuSize('compact')} checked={menuSize === 'compact'} />
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-small" onChange={() => changeMenuSize('condensed')} checked={menuSize === 'condensed'} />
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-small-hover" onChange={() => changeMenuSize('sm-hover')} checked={menuSize === 'sm-hover'} />
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-full" onChange={() => changeMenuSize('full')} checked={menuSize === 'full'} />
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-fullscreen" defaultValue="fullscreen" onChange={() => changeMenuSize('fullscreen')} checked={menuSize === 'fullscreen'} />

...
CREATE TABLE `ClientProfile` (
    ...
    UNIQUE INDEX `ClientProfile_userId_key`(`userId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ClientService` (
    ...
    INDEX `ClientService_clientId_fkey`(`clientId` ASC),
    INDEX `ClientService_productId_fkey`(`productId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `DomainDetail` (
    ...
    UNIQUE INDEX `DomainDetail_clientServiceId_key`(`clientServiceId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `InvoiceItem` (
    ...
    INDEX `InvoiceItem_productId_fkey`(`productId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Payment` (
    ...
    INDEX `Payment_clientId_fkey`(`clientId` ASC),
    INDEX `Payment_invoiceId_fkey`(`invoiceId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PaymentGatewaySetting` (
    ...
    `updatedAt` DATETIME(3) NOT NULL,
    `onlinePaymentCharge` DOUBLE NOT NULL DEFAULT 2,
...
CREATE TABLE `Quotation` (
    ...
    INDEX `Quotation_clientId_fkey`(`clientId` ASC),
    UNIQUE INDEX `Quotation_quoteNumber_key`(`quoteNumber` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `QuotationItem` (
    ...
    INDEX `QuotationItem_productId_fkey`(`productId` ASC),
    INDEX `QuotationItem_quotationId_fkey`(`quotationId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `RadioServerDetail` (
    ...
    UNIQUE INDEX `RadioServerDetail_clientServiceId_key`(`clientServiceId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Renewal` (
    ...
    INDEX `Renewal_clientServiceId_fkey`(`clientServiceId` ASC),
    UNIQUE INDEX `Renewal_invoiceId_key`(`invoiceId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `SupportMessage` (
    ...
    INDEX `SupportMessage_senderId_fkey`(`senderId` ASC),
    INDEX `SupportMessage_ticketId_fkey`(`ticketId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `SupportTicket` (
    ...
    INDEX `SupportTicket_clientId_fkey`(`clientId` ASC),
    INDEX `SupportTicket_clientServiceId_fkey`(`clientServiceId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `TaxSetting` (
    ...
    `percentage` DOUBLE NOT NULL DEFAULT 18,
    `updatedAt` DATETIME(3) NOT NULL,
